...
<RR>ЖД</RR>
    ...
    <date> - замащется на текузую дату формата дд.мм.гггг 
    <okt_mail> - в случаях, если письмо требуется отправить копией кому-то, то замещается на почтовые адреса,
тех кому это письмо пойдёт копией (для откябрьской ЖД в Сетунь и Тракт - Капусте, для Приволжской жд в Сетунь - Шулятьеву).
А если такх нет - тег затирается.
...
в тегах <RR> 
    ...
    <table> - замещается таблицкй с информацией о передоваемых файлах
